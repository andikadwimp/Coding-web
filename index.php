...
.gc img{position:absolute!important;top:0!important;left:0!important;width:100%!important;height:100%!important;object-fit:cover!important;object-position:center;display:block;transform:scale(1.06);transform-origin:center;transition:transform .5s cubic-bezier(.16,1,.3,1)}
...
<!-- ═══ FOOTER: Tentang, Penyedia, Lisensi, Disclaimer ═══ -->
<style>
...
.sf-brand{display:flex;align-items:center;justify-content:center;gap:10px;margin-bottom:18px;text-align:center}
...
.sf-tagline{text-align:center;font-size:.78rem;color:var(--t2);font-weight:500;line-height:1.55;margin-bottom:22px;max-width:380px;margin-left:auto;margin-right:auto}
...
.sf-info-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:16px}
...
<div class="site-foot">
  <div class="sf-inner">
    ...
    <div class="sf-brand">
      <?php if($_footLogo): ?>
        <img src="<?=htmlspecialchars(normUrl($_footLogo))?>" alt="<?=htmlspecialchars($sets['site_name']??'Logo')?>" class="sf-brand-logo" onerror="this.style.display='none'">
      <?php else: ?>
        <div class="sf-brand-name"><?=htmlspecialchars($sets['site_name']??'Situs')?></div>
      <?php endif; ?>
    </div>
